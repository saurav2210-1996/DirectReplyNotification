...
import com.codility.video_compress.CompressionListener
import com.codility.video_compress.CompressionProgressListener
import com.codility.video_compress.Compressor.compressVideo
import com.codility.video_compress.Compressor.isRunning
...
object VideoCompressor : CoroutineScope by MainScope() {
    ...
    private suspend fun startCompression(
        ...
        keepOriginalResolution: Boolean,
        listener: CompressionListener
    ): com.codility.video_compress.Result = withContext(Dispatchers.IO) {
