...
public class Track {
    ...
    private final ArrayList<com.codility.video_compress.Sample> samples = new ArrayList<>();
    ...
    public void addSample(long offset, MediaCodec.BufferInfo bufferInfo) {
        ...
        samples.add(new com.codility.video_compress.Sample(offset, bufferInfo.size));
    ...
    public ArrayList<com.codility.video_compress.Sample> getSamples() {
        return samples;
    }
