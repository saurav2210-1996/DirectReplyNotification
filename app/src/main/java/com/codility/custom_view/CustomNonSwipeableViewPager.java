...
//    }
   ...
   /* @Override
     ...
     *//*
            ...
            case MotionEvent.ACTION_UP:
                if (mIsBeingDragged) {
                    ...
                    setCurrentItemInternal(nextPage, false, true, initialVelocity);
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mIsBeingDragged) {
                    setCurrentItemInternal(mCurItem, false, true);
                    mActivePointerId = INVALID_POINTER;
                    endDrag();
                    needsInvalidate = mLeftEdge.onRelease() | mRightEdge.onRelease();
                }
    ...
    public void endFakeDrag() {
        ...
        if ((Math.abs(initialVelocity) > mMinimumVelocity)
            ...
            if (mLastMotionX > mInitialMotionX) {
                setCurrentItemInternal(mCurItem - 1, false, true);
            } else {
                setCurrentItemInternal(mCurItem + 1, false, true);
            }
        } else {
    ...
    public interface OnPageChangeListener {
         ...
         * @see com.bubble.android.CustomClass.CustomNonSwipeableViewPager#SCROLL_STATE_IDLE
         * @see com.bubble.android.CustomClass.CustomNonSwipeableViewPager#SCROLL_STATE_DRAGGING
         * @see com.bubble.android.CustomClass.CustomNonSwipeableViewPager#SCROLL_STATE_SETTLING
         */
