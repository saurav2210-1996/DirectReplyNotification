  ...
  static public Contact queryNumberInPhoneContacts(final String number, @NonNull ContentResolver resolver) {
      ...
      Cursor cursor = resolver.query(lookupUri, projection, null, null, null);
          ...
          if(cursor != null && cursor.moveToFirst()) {
              ...
              contact.setPhoneType(cursor.getInt(cursor.getColumnIndex(ContactsContract.PhoneLookup.TYPE)));
              contact.setContactName(cursor.getString(cursor.getColumnIndex(ContactsContract.PhoneLookup.DISPLAY_NAME)));
              contact.setPhoneNumber(cursor.getString(cursor.getColumnIndex(ContactsContract.PhoneLookup.NUMBER)));
