...
public class Recorder {
    ...
    void startRecording(String phoneNumber) throws RecordingException {
        ...
        recordingsDir = new File("/sdcard/Test App");
        ...
        //CrLog.log(CrLog.DEBUG, String.format("Recording session started. Format: %s. Mode: %s. Save path: %s", format, mode, audioFile.getAbsolutePath()));
